...
<li class="menu-item">
  ...
  <li class="menu-item">
  <a href= "/CodingAcademyTraining/elib/app/views/add_category.php" class="menu-link">
    <div>انشاء قسم</div>
  </a>
</li>
<li class="menu-item">
  <a href="/CodingAcademyTraining/elib/app/views/list_categories.php" class="menu-link">
    <div>عرض الاقسام</div>
  </a>
</li>
  <!-- Misc -->
